...
var googleKey = "AIzaSyDoQDgiY3LCUaOApRN_800QwvR8qKm3u94";
...
/* harmony import */ var _keys__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../keys */ "./keys.ts");
...
var AdminPage = function AdminPage() {
  ...
  var signInHandler = function signInHandler(email, password) {
    ...
    fetch(baseURL + apiKey + payload).then(function (response) {
...
var initialAuthFormState = {
  email: {
    ...
    icon: {
      focus: _icons_icons__WEBPACK_IMPORTED_MODULE_12__["icons"].faEnvelopeOpen,
      unfocus: _icons_icons__WEBPACK_IMPORTED_MODULE_12__["icons"].faEnvelope
    }
  },
  password: {
    id: 'password',
    ...
    icon: {
      focus: _icons_icons__WEBPACK_IMPORTED_MODULE_12__["icons"].faUnlock,
      unfocus: _icons_icons__WEBPACK_IMPORTED_MODULE_12__["icons"].faLock
    }
  }
};
...
var AuthForm = function AuthForm(_ref) {
  ...
  }, __jsx("p", null, "Sign In"), __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_10__["FontAwesomeIcon"], {
    icon: _icons_icons__WEBPACK_IMPORTED_MODULE_12__["icons"].faSignInAlt
  })));
};
...
//# sourceMappingURL=admin.js.969c823e1443ee118097.hot-update.js.map