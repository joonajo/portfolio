...
var PortfolioItem = function PortfolioItem(_ref) {
  ...
  }, __jsx("p", null, item.title), confirmDelete && __jsx(ConfirmDelete, {
...
var DeleteButton = function DeleteButton() {
  var _React$useState5 = react__WEBPACK_IMPORTED_MODULE_1__["useState"](false),
      ...
      showConfirm = _React$useState6[0],
      setShowConfirm = _React$useState6[1];
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, __jsx("div", {
    ...
    icon: _icons_icons__WEBPACK_IMPORTED_MODULE_3__["icons"].faTrash
  }), " ", __jsx("p", null, "delete"), "  "), confirm && __jsx("div", null, __jsx("p", null, "yes"), __jsx("p", null, "no")));
};
...
//# sourceMappingURL=admin.js.487921bb2a08cb13b2be.hot-update.js.map