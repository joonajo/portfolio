  ...
  react__WEBPACK_IMPORTED_MODULE_11__["useEffect"](function () {
    if (portfolioState && portfolioDispatch) {
      if (portfolioState.items.length === 0) {
        ...
        var tokenParam = "?auth=".concat(token);
        var newItems = [];
...
var PortfolioItem = function PortfolioItem(props) {
  ...
  }, __jsx("span", null, " ", __jsx("p", null, "edit"), " "), __jsx("span", null, " ", __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_14__["FontAwesomeIcon"], {
...
//# sourceMappingURL=admin.js.489ca03acda94c10940f.hot-update.js.map