...
var fetchItems = function fetchItems(state, action) {
  ...
  fetch(baseURL, {
    ...
    if (data) {
      _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_7___default()(data).forEach(function (item) {
        console.log(data[item]);
        newItems.push(data[item]);
      });
    }

    return setFetchedItems(state, newItems);
  });
  return _objectSpread({}, state);
};

var setFetchedItems = function setFetchedItems(state, payload) {
  return _objectSpread({}, state, {
    items: payload
  });
};
...
var addItem = function addItem(state, action) {
  ...
  var updatedItems = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_6__["default"])(state.items);
...
var deleteItem = function deleteItem(state, action) {
  ...
  var updatedItems = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_6__["default"])(state.items).filter(function (item) {
...
var PortfolioProvider = function PortfolioProvider(_ref) {
  ...
  var _React$useReducer = react__WEBPACK_IMPORTED_MODULE_9___default.a.useReducer(portfolioReducer, initialPortfolioState),
      _React$useReducer2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_5__["default"])(_React$useReducer, 2),
...
//# sourceMappingURL=index.js.d5a9172c9ab866c422f4.hot-update.js.map