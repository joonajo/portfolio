...
var initialForm = {
  ...
  languages: {
    id: 'languages',
    elemType: 'select',
    options: Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_8__["default"])(_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_7___default()(_context_portfolioContext__WEBPACK_IMPORTED_MODULE_10__["Languages"]).map(function (language) {
      return {
        name: language,
        selected: false
      };
...
var FormInput = react__WEBPACK_IMPORTED_MODULE_9__["memo"](function (_ref2) {
  ...
  switch (item.elemType) {
    ...
    case 'select':
      content = __jsx("div", null, item.options.map(function (option) {
        return [__jsx("p", null, option.name)];
      }));
      break;
  }
...
//# sourceMappingURL=admin.js.30b8d6584bd236875481.hot-update.js.map