...
var initialAuthFormState = {
  email: {
    ...
    icon: {
      focus: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_10__["faEnvelopeOpen"],
      unfocus: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_10__["faEnvelope"]
    }
  },
  password: {
    id: 'password',
    ...
    icon: {
      focus: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_10__["faUnlock"],
      unfocus: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_10__["faLock"]
    }
  },
  submit: {
    id: 'submit',
...
var AuthForm = function AuthForm(_ref) {
  ...
  var _React$useState3 = react__WEBPACK_IMPORTED_MODULE_9__["useState"](initialAuthFormState),
  ...
  return __jsx("div", {
    ...
    return __jsx(InputComponent, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_5__["default"])({}, formState[elementKey], {
...
var InputComponent = function InputComponent(props) {
  ...
  var icon = isFocused ? (_props$icon = props.icon) === null || _props$icon === void 0 ? void 0 : _props$icon.focus : (_props$icon2 = props.icon) === null || _props$icon2 === void 0 ? void 0 : _props$icon2.unfocus;
  return __jsx("div", {
...
//# sourceMappingURL=admin.js.7b457d25764ad62fefba.hot-update.js.map