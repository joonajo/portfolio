...
var ItemForm = function ItemForm(_ref) {
  ...
  var addHandler = function addHandler() {
    var newItem = {
      ...
      language: Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_6__["default"])(form.languages.selected),
  ...
  switch (item.elemType) {
    ...
    case 'select':
      content = __jsx("div", {
        ...
        console.log(item.options[option].selected);
        return __jsx("span", {
          key: option.name,
...
//# sourceMappingURL=admin.js.8232878e6eef11a36426.hot-update.js.map