...
var initialForm = {
  ...
  languages: {
    ...
    options: _objectSpread({}, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_7___default()(_context_portfolioContext__WEBPACK_IMPORTED_MODULE_10__["Languages"]).map(function (language) {
      return Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])({}, language, {
        selected: false
      });
    })),
    selected: [],
...
var FormInput = react__WEBPACK_IMPORTED_MODULE_9__["memo"](function (_ref3) {
  var item = _ref3.item,
      change = _ref3.change,
      ...
      content = __jsx("div", {
        ...
        return __jsx("span", {
          ...
          onClick: function onClick() {
            return clickOption(item.id, option.name);
          }
        }, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_7___default()(option));
      }));
      break;
  }
...
//# sourceMappingURL=admin.js.f5a4857bb7e51e28d442.hot-update.js.map