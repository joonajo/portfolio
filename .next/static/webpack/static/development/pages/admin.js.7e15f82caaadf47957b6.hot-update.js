...
/* harmony import */ var _UI_Spinner_Spinner__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../UI/Spinner/Spinner */ "./components/UI/Spinner/Spinner.tsx");
...
var ItemForm = function ItemForm(_ref) {
  ...
  var optionClickHandler = function optionClickHandler(id, name) {
    var updatedForm = _objectSpread({}, form, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])({}, id, _objectSpread({}, form[id], {
      options: _objectSpread({}, form[id].options, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])({}, name, _objectSpread({}, form[id].options[name], {
  ...
  var changeHandler = function changeHandler(id, event) {
    ...
    updatedForm = _objectSpread({}, form, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])({}, id, _objectSpread({}, form[id], {
  ...
  var addHandler = function addHandler() {
    var selectedLanguages = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_6___default()(form.languages.options).filter(function (option) {
  ...
  }, __jsx(_UI_Spinner_Spinner__WEBPACK_IMPORTED_MODULE_10__["CubeSpinner"], null)), __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_11__["FontAwesomeIcon"], {
...
var FormInput = react__WEBPACK_IMPORTED_MODULE_9__["memo"](function (_ref2) {
  ...
  switch (item.elemType) {
    ...
    case 'select':
      ...
      }, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_6___default()(item.options).map(function (option) {
...
//# sourceMappingURL=admin.js.7e15f82caaadf47957b6.hot-update.js.map