...
var Cover = react__WEBPACK_IMPORTED_MODULE_1___default.a.memo(function () {
  ...
  var arrowTextClasses = [css.ArrowText, arrowIn ? css["in"] : css.out].join(' ');
  ...
  var hoverHandler = function hoverHandler(mouseIn) {
    setArrowIn(mouseIn); // if (arrowIn === undefined) {
    //     setArrowIn(true)
    // }
  };
...
//# sourceMappingURL=index.js.1edfbe1d7e9b63a4f008.hot-update.js.map