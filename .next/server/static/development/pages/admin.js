...
const AdminPage = () => {
  ...
  const signInHandler = (email, password) => {
    ...
    fetch(baseURL + apiKey + payload).then(response => {
...
const AuthForm = ({
  ...
  const [formState, setFormState] = react__WEBPACK_IMPORTED_MODULE_8__["useState"](initialAuthFormState);
  react__WEBPACK_IMPORTED_MODULE_8__["useEffect"](() => {
  ...
  }, __jsx("p", null, "Sign In"), __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_9__["FontAwesomeIcon"], {
...
const InputComponent = props => {
  ...
  const [isFocused, setIsFocused] = react__WEBPACK_IMPORTED_MODULE_8__["useState"](false);
