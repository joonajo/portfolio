...
const AuthContext = react__WEBPACK_IMPORTED_MODULE_0___default.a.createContext(authContextState);
const AuthProvider = ({
  children
}) => {
  const [state, dispatch] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useReducer(authReducer, initialAuthState);
...
class MyApp extends next_app__WEBPACK_IMPORTED_MODULE_1___default.a {
  ...
  render() {
    ...
    return __jsx(_context_authContext__WEBPACK_IMPORTED_MODULE_2__["AuthProvider"], null, __jsx(_context_portfolioContext__WEBPACK_IMPORTED_MODULE_3__["PortfolioProvider"], null, __jsx(Component, pageProps)));
  }
